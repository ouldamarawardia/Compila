...
public ArrayList<String> S=new ArrayList<String>();
	...
	public ArrayList<String> P(ArrayList<String>P) {
		...
		if(ligne<P.size()&&P.get(0).equals("STARTP")) {
			System.out.println("Start_Program	->Debut de program roconnue");
			S.add("Start_Program	->Debut de program roconnue");
			istruction.add(" ");
			ligne++;
			insts(P);
			if(ligne<P.size()&&P.get(ligne).equals("ENDP")) {
				System.out.println("End_Program	->Fin de program roconnue");
				S.add("End_Program	->Fin de program roconnue");
				istruction.add(" ");
				ligne++;
				if(ligne<P.size()) {
				...
				System.out.println("	->erreur syntaxique dans la ligne  "+(ligne+1));
